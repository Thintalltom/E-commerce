  ...
  return (
    <div >
      <div className=" flex justify-center align-center   h-[180px]">
        <img src={image} className="lg:w-[200px] xxs:w-[80px] md:w-[200px] xs:w-[100px] h-[150px] mt-[30px]" />
      </div>
      <div className=" xs:w-[200px] md:w-[345px]  shadow-sm text-slate-900 grid text-sm content-center lg:w-[345px]  p-4 ">
        ...
        <Link to={`/detail/${id}`}>
          <button className="bg-slate-900 text-white  h-[50px] rounded-[10px] text-sm  hover:shadow-md shadow-sm xxs:w-[100px] xs:w-[150px] lg:w-[200px] p-[2px] mt-4 ">
            View details
          </button>
        </Link>
        </div>
